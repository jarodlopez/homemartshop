...
export default function CartDrawer() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // 2. Referencia a la ruta base de datos del POS
      ...
      // Esto actualiza el campo 'stock' restando la cantidad comprada
      $items.forEach(item => {
      ...
      // 6. Éxito: Enviar a WhatsApp y limpiar
      ...
      // Opcional: Limpiar carrito aquí si lo deseas
      // cartItems.set([]); 
  ...
  // Importamos funciones del store localmente para usarlas en el JSX
            ...
            <div className="p-6 bg-white border-t shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
              ...
              <div className="space-y-3 mb-6 text-sm">
                ...
                <div className="flex justify-between font-extrabold text-xl text-gray-900 pt-4 border-t">
                  <span>Total</span>import React, { useState } from 'react';
import { useStore } from '@nanostores/react';
import { isCartOpen, cartItems, cartTotal, appliedDiscount, applyDiscountCode } from '../store/cartStore';
import { X, Plus, Minus, Tag, MessageCircle, Loader2 } from 'lucide-react';
import { db } from '../lib/firebase';
